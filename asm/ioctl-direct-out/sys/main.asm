...
public DriverEntry
IOCTL_DIRECT_GET  equ CTL_CODE(FILE_DEVICE_UNKNOWN, 800h, METHOD_OUT_DIRECT, FILE_ANY_ACCESS)
IOCTL_DIRECT_SET  equ CTL_CODE(FILE_DEVICE_UNKNOWN, 801h, METHOD_OUT_DIRECT, FILE_ANY_ACCESS)

.const
DEV_NAME word "\","D","e","v","i","c","e","\","f","i","r","s","t","I","O","C","T","L","-","D","i","r","e","c","t","-","O","u","t",0
SYM_NAME word "\","D","o","s","D","e","v","i","c","e","s","\","f","i","r","s","t","I","O","C","T","L","-","D","i","r","e","c","t","-","O","u","t",0
MSG db "KMDF driver tutorial for Device IOCTL-Direct-Out",0
