...
.const
DEV_NAME word "\","D","e","v","i","c","e","\","f","i","r","s","t","F","i","l","e","-","B","u","f","f","e","r",0
SYM_NAME word "\","D","o","s","D","e","v","i","c","e","s","\","f","i","r","s","t","F","i","l","e","-","B","u","f","f","e","r",0
MSG db "KMDF driver tutorial for File-Buffer",0
...
IrpRead proc Queue:WDFQUEUE, Request:WDFREQUEST, _Length:DWORD
  ...
  invoke WdfMemoryCopyFromBuffer, memory, 0, offset szBuffer, _Length
...
IrpWrite proc Queue:WDFQUEUE, Request:WDFREQUEST, _Length:DWORD
  ...
  invoke WdfMemoryCopyToBuffer, memory, 0, offset szBuffer, _Length
  invoke DbgPrint, $CTA0("Buf: %s, Len:%d"), offset szBuffer, _Length
  invoke WdfRequestCompleteWithInformation, Request, STATUS_SUCCESS, _Length
  ret
IrpWrite endp
