...
.const
DEV_NAME word "\","D","e","v","i","c","e","\","f","i","r","s","t","I","O","C","T","L","-","N","e","i","t","h","e","r",0
SYM_NAME word "\","D","o","s","D","e","v","i","c","e","s","\","f","i","r","s","t","I","O","C","T","L","-","N","e","i","t","h","e","r",0
MSG db "KMDF driver tutorial for Device IOCTL-Neither",0
...
IrpIOCTL proc Queue:WDFQUEUE, Request:WDFREQUEST, OutputBufferLength:DWORD, InputBufferLength:DWORD, IoControlCode:DWORD
  ...
  .if IoControlCode == IOCTL_NEITHER_SET
    invoke DbgPrint, $CTA0("_IOCTL_NEITHER_SET")
  ...
  .elseif IoControlCode == IOCTL_NEITHER_GET
    invoke DbgPrint, $CTA0("_IOCTL_NEITHER_GET")
