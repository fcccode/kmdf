...
.const
DEV_NAME word "\","D","e","v","i","c","e","\","f","i","r","s","t","C","a","n","c","e","l",0
SYM_NAME word "\","D","o","s","D","e","v","i","c","e","s","\","f","i","r","s","t","C","a","n","c","e","l",0
MSG db "KMDF driver tutorial for Cancel",0
...
IrpIOCTL proc uses ebx edx Queue:WDFQUEUE, Request:WDFREQUEST, OutputBufferLength:DWORD, InputBufferLength:DWORD, IoControlCode:DWORD
  .if IoControlCode == IOCTL_QUEUE_IT
    ...
    invoke WdfRequestMarkCancelable, Request, offset IrpCancel
  .endif
  ret
IrpIOCTL endp
